...
def pretrain(model, train_loader, val_loader, config, pretrained_path=None):
    ...
    for epoch in range(config.pretrain_epochs):
        ...
        with torch.no_grad():
            for masked_batch, original_batch, mask in val_loader:
                ...
                val_ssim += calculate_ssim(output, original_batch, mask).item()
    ...
    # Plotting
    plot_metrics(train_losses, val_losses, train_psnrs, val_psnrs, train_ssims, val_ssims)

def plot_metrics(train_losses, val_losses, train_psnrs, val_psnrs, train_ssims, val_ssims):
